...
-- Géométries des IRIS de Paris
CREATE TABLE IF NOT EXISTS gold.iris_geo (
...
-- KPIs agrégés par IRIS × année
CREATE TABLE IF NOT EXISTS gold.iris_kpis (
...
CREATE INDEX IF NOT EXISTS idx_iris_kpis_id        ON gold.iris_kpis (iris_id);
CREATE INDEX IF NOT EXISTS idx_iris_kpis_arr       ON gold.iris_kpis (arrondissement);
CREATE INDEX IF NOT EXISTS idx_iris_kpis_annee     ON gold.iris_kpis (annee);
...
CREATE INDEX IF NOT EXISTS idx_iris_geo_arr        ON gold.iris_geo (arrondissement);
CREATE INDEX IF NOT EXISTS idx_iris_geo_quartier   ON gold.iris_geo (quartier_id);
CREATE INDEX IF NOT EXISTS idx_iris_geom           ON gold.iris_geo USING GIST (geom);
